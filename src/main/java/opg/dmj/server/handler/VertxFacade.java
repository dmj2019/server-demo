...
import opg.dmj.server.handler.OccupationHandler;
...
public class VertxFacade extends AbstractVerticle {
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        occupationAsyncService = new ServiceProxyBuilder(vertx).setAddress(OccupationAsyncService.ADDRESS).build(OccupationAsyncService.class);
    ...
    private void startServer(Handler<AsyncResult<HttpServer>> next) {
        ...
        apiRouter.mountSubRouter("/occupation", new OccupationHandler(vertx, occupationAsyncService).createRouter());
